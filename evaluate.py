...
def main():
    ...
    parser.add_argument("--gt_masks_dir", type=str, required=True, help="Directory containing ground-truth masks")
    parser.add_argument("--pred_masks_dir", type=str, required=True, help="Directory containing predicted masks")
    
    args = parser.parse_args()

    mean_metrics = compute_metrics_batch(args.gt_masks_dir, args.pred_masks_dir).round(3)
